 ...
 *
 * At every insertion, it checks if the item is present or not in the Double Linked List. If it is present,
 * it is going to be moved to the Head (extreme left side), and all items remain are going to be shifted to the right.
 *
 * Otherwise, that the item inserted is not present in the Double Linked List, the last item Tail (extreme right)
 * is going to be removed, and the new item is going to be inserted at the head (extreme left side.)
 *
