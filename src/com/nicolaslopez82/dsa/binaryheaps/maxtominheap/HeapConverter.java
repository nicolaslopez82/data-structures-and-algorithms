package com.nicolaslopez82.dsa.binaryheaps.maxtominheap;

/**
 * Converting max heap to min heap overview
 * Interview Question #2
 *
 * Design an algorithms thats able to convert a minimum heap into a maximum heap!
 */
